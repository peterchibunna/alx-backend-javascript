...
describe("calculateNumber", function () {
  // ['SUM', 'SUBTRACT', 'DIVIDE'].forEach(function ('SUM') {
  /*
  describe("Operation: SUM", function () {
    it(`between 2 integers`, function () {
      const a = 1, b = 2;
      assert.strictEqual(calculateNumber('SUM', a, b), 3);
    });
    it(`between rh float [mid-point] and lh integer`, function () {
      const a = 1, b = 2.5;
      assert.strictEqual(calculateNumber('SUM', a, b), 4);
    });
    ...
    it(`between both floats [mid-point]`, function () {
      const b = 2.5, a = 4.5;
      assert.strictEqual(calculateNumber('SUM', a, b), 8);
    });
    it(`between both floats [1 mid-point and 1-upper-range]`, function () {
      const b = 5.5, a = 4.8;
      assert.strictEqual(calculateNumber('SUM', a, b), 11);
    });
    it(`between both floats [1 mid-point and 1-lower-range]`, function () {
      const b = 5.2, a = 4.8;
      assert.strictEqual(calculateNumber('SUM', a, b), 10);
    });
    ...
    it(`between both floats: 1 negative recurring decimal numbers`, function () {
      const a = -5.996666666, b = 4.999999999999;
      assert.strictEqual(calculateNumber('SUM', a, b), -1);
    });
    ...
    it(`between zero on rhs`, function () {
      ...
      assert.strictEqual(calculateNumber('SUM', a, b), 6);
    });
    it(`between zero on lhs`, function () {
      const b = 5.3467, a = 0;
      assert.strictEqual(calculateNumber('SUM', a, b), 5);
    });
    it(`between all zeroes`, function () {
      const a = 0, b = 0;
      assert.strictEqual(calculateNumber('SUM', a, b), 0);
    });
    ...
    it('equal positive numbers (alternate)', () => {
      const a = 5.2, b = 8.7;
      assert.strictEqual(calculateNumber('SUM', a, b), 14);
    });
  ...
  */
  describe("Operation: SUBTRACT", function () {
    it(`between 2 integers`, function () {
      const a = 1, b = 2;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), -1);
    });
    it(`between rh float [mid-point] and lh integer`, function () {
      const a = 1, b = 2.5;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), -2);
    });
    it(`between rh float [lower half] and lh integer`, function () {
      const a = 1, b = 2.4;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), -1);
    ...
    it(`between both floats [1 mid-point and 1-lower-range]`, function () {
      const b = 5.2, a = 4.8;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), 0);
    });
    it(`between both floats: 2 recurring decimal numbers #1`, function () {
      const b = 5.333333333333, a = 4.999999999999;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), 0);
    ...
    it(`between both floats: 1 negative recurring decimal numbers`, function () {
      const a = -5.996666666, b = 4.999999999999;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), -11);
    });
    it(`between both floats: 2 negative recurring decimal numbers`, function () {
      const a = -5.996666666, b = -4.999999999999;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), -1);
    ...
    it(`between zero on rhs`, function () {
      const a = 5.996666666, b = 0;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), 6);
    });
    it(`between zero on lhs`, function () {
      const b = 5.3467, a = 0;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), -5);
    });
    it(`between all zeroes`, function () {
      const a = 0, b = 0;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), 0);
    ...
    it('equal positive numbers (alternate)', () => {
      const a = 5.2, b = 8.7;
      assert.strictEqual(calculateNumber('SUBTRACT', a, b), -4);
    });
