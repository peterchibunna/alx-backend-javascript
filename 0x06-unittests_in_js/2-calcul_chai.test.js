...
describe("calculateNumber", function () {
  describe("Operation: SUM", function () {
    it(`between 2 integers`, function () {
      const a = 1, b = 2;
      expect(calculateNumber('SUM', a, b)).to.equal(3);
    });
    it(`between rh float [mid-point] and lh integer`, function () {
      const a = 1, b = 2.5;
      expect(calculateNumber('SUM', a, b)).to.equal(4);
    });
    ...
    it(`between both floats [mid-point]`, function () {
      const b = 2.5, a = 4.5;
      expect(calculateNumber('SUM', a, b)).to.equal(8);
    });
    it(`between both floats [1 mid-point and 1-upper-range]`, function () {
      const b = 5.5, a = 4.8;
      expect(calculateNumber('SUM', a, b)).to.equal(11);
    });
    it(`between both floats [1 mid-point and 1-lower-range]`, function () {
      const b = 5.2, a = 4.8;
      expect(calculateNumber('SUM', a, b)).to.equal(10);
    });
    ...
    it(`between both floats: 1 negative recurring decimal numbers`, function () {
      const a = -5.996666666, b = 4.999999999999;
      expect(calculateNumber('SUM', a, b)).to.equal(-1);
    });
    ...
    it(`between zero on lhs`, function () {
      const b = 5.3467, a = 0;
      expect(calculateNumber('SUM', a, b)).to.equal(5);
    });
    it(`between all zeroes`, function () {
      const a = 0, b = 0;
      expect(calculateNumber('SUM', a, b)).to.equal(0);
    });
    ...
    it('equal positive numbers (alternate)', () => {
      const a = 5.2, b = 8.7;
      expect(calculateNumber('SUM', a, b)).to.equal(14);
    });
  ...
  describe("Operation: SUBTRACT", function () {
    it(`between 2 integers`, function () {
      const a = 1, b = 2;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(-1);
    });
    it(`between rh float [mid-point] and lh integer`, function () {
      const a = 1, b = 2.5;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(-2);
    });
    it(`between rh float [lower half] and lh integer`, function () {
      const a = 1, b = 2.4;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(-1);
    ...
    it(`between both floats [1 mid-point and 1-lower-range]`, function () {
      const b = 5.2, a = 4.8;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(0);
    });
    it(`between both floats: 2 recurring decimal numbers #1`, function () {
      const b = 5.333333333333, a = 4.999999999999;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(0);
    ...
    it(`between both floats: 1 negative recurring decimal numbers`, function () {
      const a = -5.996666666, b = 4.999999999999;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(-11);
    });
    it(`between both floats: 2 negative recurring decimal numbers`, function () {
      const a = -5.996666666, b = -4.999999999999;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(-1);
    ...
    it(`between zero on rhs`, function () {
      const a = 5.996666666, b = 0;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(6);
    });
    it(`between zero on lhs`, function () {
      const b = 5.3467, a = 0;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(-5);
    });
    it(`between all zeroes`, function () {
      const a = 0, b = 0;
      expect(calculateNumber('SUBTRACT', a, b)).to.equal(0);
  ...
  describe("Operation: DIVIDE", function () {
    it(`between 2 integers`, function () {
      const a = 1, b = 2;
      expect(calculateNumber('DIVIDE', a, b)).to.equal(0.5);
    });
    it(`between rh float [mid-point] and lh integer`, function () {
      const a = 1, b = 2.5;
      expect(calculateNumber('DIVIDE', a, b)).to.equal(0.3333333333333333);
    });
    it(`between rh float [lower half] and lh integer`, function () {
      const a = 1, b = 2.4;
      expect(calculateNumber('DIVIDE', a, b)).to.equal(0.5);
    ...
    it(`between lh float [mid-point] and rh integer`, function () {
      const b = 1, a = 2.5;
      expect(calculateNumber('DIVIDE', a, b)).to.equal(3);
    });
    it(`between lh float [lower half] and rh integer`, function () {
      const b = 1, a = 2.2;
      expect(calculateNumber('DIVIDE', a, b)).to.equal(2);
    });
    it(`between lh float [upper half] and rh integer`, function () {
      const b = 1, a = 2.8;
      expect(calculateNumber('DIVIDE', a, b)).to.equal(3);
    ...
    it(`between both floats [mid-point]`, function () {
      const b = 2.5, a = 4.5;
      expect(calculateNumber('DIVIDE', a, b)).to.equal(1.6666666666666667);
    });
    // it(`between both floats [1 mid-point and 1-upper-range]`, function () {
    //   const b = 5.5, a = 4.8;
    //   expect(calculateNumber('DIVIDE', a, b)).to.equal( -1);
    // });
    // it(`between both floats [1 mid-point and 1-lower-range]`, function () {
    //   const b = 5.2, a = 4.8;
    //   expect(calculateNumber('DIVIDE', a, b)).to.equal( 0);
    // });
    // it(`between both floats: 2 recurring decimal numbers #1`, function () {
    //   const b = 5.333333333333, a = 4.999999999999;
    //   expect(calculateNumber('DIVIDE', a, b)).to.equal( 0);
    ...
    // it(`between both floats: 1 negative recurring decimal numbers`, function () {
    //   const a = -5.996666666, b = 4.999999999999;
    //   expect(calculateNumber('DIVIDE', a, b)).to.equal( -11);
    // });
    // it(`between both floats: 2 negative recurring decimal numbers`, function () {
    //   const a = -5.996666666, b = -4.999999999999;
    //   expect(calculateNumber('DIVIDE', a, b)).to.equal( -1);
    ...
    // it(`between zero on rhs`, function () {
    //   const a = 5.996666666, b = 0;
    //   expect(calculateNumber('DIVIDE', a, b)).to.equal( 6);
    // });
    // it(`between zero on lhs`, function () {
    //   const b = 5.3467, a = 0;
    //   expect(calculateNumber('DIVIDE', a, b)).to.equal( -5);
    // });
